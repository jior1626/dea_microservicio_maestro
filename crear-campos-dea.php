...
$columnQuery = "SELECT column_name FROM information_schema.columns WHERE table_name = 'tbl_dea'";
...
<div class="container">
    ...
    <form action="procesar-dea.php" method="post">
