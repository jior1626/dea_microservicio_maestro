...
$columnQuery = "SELECT column_name FROM information_schema.columns WHERE table_name = 'tbl_agenda'";
...
$dataQuery = "SELECT * FROM TBL_AGENDA";
...
<div class="container">
    ...
    <form action="procesar-agenda.php" method="post">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php 
                echo '<form id="insertForm" method="post" action="guardar-agenda.php">';
                foreach ($columns as $columnName) {
