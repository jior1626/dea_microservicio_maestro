...
$columnQuery = "SELECT column_name FROM information_schema.columns WHERE table_name = 'tbl_tipodeclaracion'";
...
$dataQuery = "SELECT * FROM TBL_TIPODECLARACION";
...
<div class="container">
    ...
    <form action="procesar-tipodeclaracion.php" method="post">
...
<div class="container">
        <h2>Tabla Tipo de declaración</h2>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php 
                echo '<form id="insertForm" method="post" action="guardar-tipodeclaracion.php">';
                foreach ($columns as $columnName) {
